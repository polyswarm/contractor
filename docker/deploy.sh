...
contractor deploy --chain side --network $SIDECHAIN -i consul -o consul/sidechain.json
echo "Deploying to homechain"
contractor deploy --chain home --network $HOMECHAIN -i consul -o consul/homechain.json
